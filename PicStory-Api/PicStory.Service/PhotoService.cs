...
namespace PicStory.SERVICE
{
    public class PhotoService:IPhotoServices
    {
        ...
        private readonly IPhotoRepository _photoRepositoryy;

        public PhotoService(IRepositoryManager photoRepository, IPhotoRepository photoRepositoryy)
        {
            _photoRepository = photoRepository;
            _photoRepositoryy = photoRepositoryy;
        }
        ...
        {
            return await _photoRepository.Photo.GetPhotosByAlbumIdAsync(albumId);
        }
